    ...
    <section className="min-h-screen bg-[#FAFAFA] p-6 lg:p-10">
      ...
      <form onSubmit={onSubmit}>
        <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <div className="my-10 border-t border-dashed border-gray-200"></div>
          ...
          <div className="mt-10 flex flex-col gap-5 border-t border-gray-100 pt-8 lg:flex-row lg:items-center lg:justify-between">
            <p className="text-sm text-gray-500">
